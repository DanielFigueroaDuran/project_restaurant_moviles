...
const Menu = () => {
    const { dishMenus, total, newMenu, handleAddToCart, handleAddMenu } = useContext(RestaurantContext);
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className='flex items-center w-full justify-between mb-4 px-4'>
                                    <div className="flex justify-center  md:text-xl   font-semibold ">{menu.title}</div>
                                    <span
                                        className='font-semibold'
                                    >
                                        {menu.price.toFixed(2).replace(/\./g, ',')} €
                                    </span>
                                </div>
                                ...
                                <div className="flex justify-center gap-4">
                                    ...
                                    <Button
                                        handleClick={() => { handleAddToCart(menu); handleAddMenu(newMenu) }}
                                        text="Añadir"
                                        style="w-40"
                                    />
                                </div>
